...
class ThemeProvider extends ChangeNotifier {
  ...
  bool _notificationsEnabled = true; // Adicionado para gerenciar notificações
  ...
  ThemeData get lightTheme => ThemeData(
        ...
        textTheme: const TextTheme(
          titleLarge: TextStyle(color: Color(0xFF24746C)), // Substitui bodyText1
          bodyLarge: TextStyle(color: Color(0xFF789F9C)), // Substitui bodyText2
  ...
  ThemeData get darkTheme => ThemeData(
        ...
        textTheme: const TextTheme(
          titleLarge: TextStyle(color: Color(0xFF70D4BE)), // Substitui bodyText1
          bodyLarge: TextStyle(color: Color(0xFF7C808D)), // Substitui bodyText2
